...
function WhyChooseUs() {
    return (
        <>
            <div className="why-choose-us py-8 lg:py-[48px] px-8 lg:px-0 flex flex-col lg:flex-row gap-[24px] justify-center items-center">

                {/* two box layout */}
                <div className="two-layout flex gap-[24px] justify-center items-center">
                    {/* Free Shiping */}
                    <div className="reason-1 bg-[#F3F5F7] w-[16.375rem] h-[13.75rem] py-[48px] px-[32px] flex flex-col justify-start items-start gap-[16px]">
                    ...
                    {/* Money-back */}
                    <div className="reason-2 bg-[#F3F5F7] w-[16.375rem] h-[13.75rem] py-[48px] px-[32px] flex flex-col justify-start items-start gap-[16px]">
                ...
                <div className="two-layout flex gap-[24px] justify-center items-center">
                    {/* Secure Payments */}
                    <div className="reason-3 bg-[#F3F5F7] w-[16.375rem] h-[13.75rem] py-[48px] px-[32px] flex flex-col justify-start items-start gap-[16px]">
                    ...
                    {/* 24/7 Support */}
                    <div className="reason-4 bg-[#F3F5F7] w-[16.375rem] h-[13.75rem] py-[48px] px-[32px] flex flex-col justify-start items-start gap-[16px]">
